...
// //  API to search a particular blog using an ID (to load old data in Edit page)
...
//     // update data in the backend array 
//     blogs[blogIndex] = {
//         ...blogs[blogIndex], // old ID and unchanged infos remains the same
//         title: req.body.title,
//         category: req.body.category,
//         author: req.body.author,
//         imageUrl: req.body["image-url"] || blogs[blogIndex].imageUrl,
